...
#### 后续内容整理（不提交，记得注释）
1. *fx67ll.com的技能点说明继续优化* **进度不错**  
2. 参考工作sql完善项目描述  
3. 面试总结快速过一遍并且分类整理，为自己之前的内容查漏补缺  
4. hive优化视频看完并结合之前的hive优化完成hive优化总结  
5. *sql题之前的总结整理完，继续做题，hive真题整理学习* **进度不错**  
6. kafka深入完成，部分组件的使用和面试题多过几遍
7. scala语法完成，继续spark学习，深入spark调优  
8. java线程深入，数据结构深入  
9. 最后有空完成一下前端简历更新，并整理一下需要看的面试题大纲  
